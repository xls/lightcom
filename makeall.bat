...
g++ -m64 -o shared-gcc-d-x64.dll   sharedlibrary.cpp -Wl,-subsystem,windows
g++ -m64 -O2 -o shared-gcc-r-x64.dll   sharedlibrary.cpp -s -Wl,-subsystem,windows
Endlocal
...
g++ -o shared-gcc-d-x86.dll -fdevirtualize  sharedlibrary.cpp -Wl,-subsystem,windows
g++ -O2 -o shared-gcc-r-x86.dll -fdevirtualize  sharedlibrary.cpp -s -Wl,-subsystem,windows
Endlocal
